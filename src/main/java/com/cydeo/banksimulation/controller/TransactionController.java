...
public class TransactionController {
    ...
    public String makeTransfer(@ModelAttribute("transaction") Transaction transaction){
        ...
        Account reciver = accountService.retrieveById(transaction.getReceiver());
        Account sender = accountService.retrieveById(transaction.getSender());
        transactionService.makeTransfer(transaction.getAmount(), new Date(), sender, reciver,transaction.getMessage());
